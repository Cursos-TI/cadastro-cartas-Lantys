...
// Variaveis da carta 1
    ...
    float carta1_den_popu;			// Recebe a densidade Populacional
	float carta1_percap;			// Recebe a renda percapita 

// Variaveis da carta 2
    
	char carta2_estado;				// Recebe as letras de A a H
    char carta2_nome_cidade;		// Recebe o numero entre 1 a 4
    char carta2_cod[4];				// Recebe a combianação de estado + cidade ex. A03, B04, H01
    ...
    float carta2_den_popu;			// Recebe a densidade Populacional
	float carta2_percap;			// Recebe a renda percapita 
...
// Definindo valores da carta 1
	...
	printf("\n - Digite o tamanho da ârea da cidade: ");
	scanf("%f", &carta1_area);
    fflush(stdin);
	...
	carta1_den_popu = carta1_popu / carta1_area;
	
	// Calcula a densidade populacional da carta 1
	carta1_percap = carta1_pib / carta1_popu;
...
// Definindo valores da carta 2
	...
	// Calcula a densidade populacional da carta 1
	carta1_den_popu = carta1_popu / carta1_area;
	// Calcula a renda per capita da carta 1
	carta1_percap = carta1_pib / carta1_popu;
	
	// Calcula a densidade populacional da carta 2
	carta2_den_popu = carta2_popu / carta2_area;
	// Calcula a renda per capita da carta 2
	carta2_percap = carta2_pib / carta2_popu;
...
// Visualizando os resultados
	...
	printf ("\n ( Area em m2) \t\t (%.2f) \t ",carta1_area);
	printf ("\n ( População em milhões ) \t (%d) \t\t ",carta1_popu);
	printf ("\n ( Renda Per Capita - PIB )\t (%.2f) \t ",carta1_pib);
	printf ("\n ( Quantidade de pontos turisticos ) (%d) \t ",carta1_pt_turis);
	printf ("\n ( Densidade populacinal) (%.2f) \t ",carta1_den_popu);
	printf ("\n ( A renda per capita ) (%.2f) \t ",carta1_percap);
	printf ("\n+------------------------------------------------+");
	...
	printf ("\n ( Area em m2) \t\t (%.2f) \t ",carta2_area);
	printf ("\n ( População em milhões ) \t (%d) \t\t ",carta2_popu);
	printf ("\n ( Renda Per Capita - PIB )\t (%.2f) \t ",carta2_pib);
	printf ("\n ( Quantidade de pontos turisticos ) (%d) \t ",carta2_pt_turis);
	printf ("\n ( Densidade populacinal ) (%.2f) \t ",carta2_den_popu);
	printf ("\n ( A renda per capita ) (%.2f) \t ",carta2_percap);
	printf ("\n+------------------------------------------------+");
